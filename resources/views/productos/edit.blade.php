                    ...
                    <form action="{{ route('productos.update', $producto->id_producto) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="descripcion" name="descripcion" rows="4"
                                      class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100">{{ old('descripcion', $producto->descripcion) }}</textarea>
                            @error('descripcion')
                                <span class="text-red-500 text-sm">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="imagen" name="imagen" value="{{ old('imagen', $producto->imagen) }}"
                                   class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                        ...
                        <div class="mb-6">
                            <label class="flex items-center">
                                <input type="checkbox" id="disponible" name="disponible" value="1"
                                       class="rounded" {{ old('disponible', $producto->disponible) ? 'checked' : '' }}>
